...
char *recieve_file(MYSQL *connection, int socket, char *number, char *info, char *base_filename);
...
char *edit_user_name_login(MYSQL *connection, char *u_id , char *new_name, char *new_login);
...
char *get_all_messages(MYSQL *connection, char *ch_id, char *last_message_id, int socket);
